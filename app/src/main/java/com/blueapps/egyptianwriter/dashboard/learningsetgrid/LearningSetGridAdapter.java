package com.blueapps.egyptianwriter.dashboard.learningsetgrid;
...
import com.blueapps.egyptianwriter.dashboard.documentgrid.DocumentMenu;
import com.blueapps.egyptianwriter.dashboard.documentgrid.DocumentMenuListener;

import java.util.ArrayList;

public class LearningSetGridAdapter extends RecyclerView.Adapter<LearningSetGridAdapter.RecyclerViewHolder>{
    private ArrayList<DocumentGridData> dataList;
    private Context context;

    private ArrayList<DocumentListener> listeners = new ArrayList<>();

    public LearningSetGridAdapter(Context context, ArrayList<DocumentGridData> dataList) {
